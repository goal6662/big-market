...
-- 导出 big_market 的数据库结构
CREATE DATABASE IF NOT EXISTS `big_market` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `big_market`;

-- 导出  表 big_market.strategy 结构
...
-- 正在导出表  big_market.strategy 的数据：~0 rows (大约)
DELETE FROM `strategy`;

-- 导出  表 big_market.strategy_award 结构
...
-- 正在导出表  big_market.strategy_award 的数据：~9 rows (大约)
...
-- 导出  表 big_market.strategy_rule 结构
...
-- 正在导出表  big_market.strategy_rule 的数据：~14 rows (大约)
